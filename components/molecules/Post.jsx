...
export default function Post() {
  return (
    <View style={{ display: "flex", backgroundColor: "white", paddingVertical: 12 }}>
      ...
      <View style={{ marginLeft: 50, paddingRight: 20 }}>
        <Text style={{ fontWeight: "700" }}>@BRIS @IHSG @ANTM</Text>
        <View style={{ marginTop: 5 }}>
          <View style={{ width: "100%", height: 160, backgroundColor: "gray", borderRadius: 10, overflow: "hidden" }}>
            <Image source={require("assets/img/2.png")} style={{ width: "100%", height: "100%" }} />
          </View>
        </View>
        <View style={{ marginTop: 10 }}>
          <Text style={{ fontSize: 12, width: "100%" }}>Hi, is the API possible to retrieve the role either is Viewer or Contributor? Additional : If Can, is it able to show the last Commit date of the Contributor?</Text>
        </View>
      </View>
